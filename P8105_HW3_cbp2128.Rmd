...
There were `r nrow(states_w_7_locs_in_2002)` states with 7 locations listed in 2002. This result suggests that only a few states had such extensive surveying done in the early years of the dataset. 
...
```{r P1_five_panel_bonanza, warning = FALSE }
...
clean_NY_NOAA = raw_NY_NOAA %>% 
  ...
  mutate(pcrp_mm = ifelse(!is.na(prcp), prcp / 10, NA),
